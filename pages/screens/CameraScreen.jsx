...
const CameraScreen = () => {
  ...
  const checkCameraPermission = async () => {
    ...
    if (status === 'granted') {
      ...
      Alert.alert('Camera Permission Required', 'Please enable camera access in settings to use this feature.');
    }
  };
  ...
  return (
    <SafeAreaProvider>
      <View style={tw`flex-1 justify-center items-center`}>
        ...
        {confirmedImage && (
          <View style={styles.imagePreviewContainer}>
            <Image source={{ uri: confirmedImage }} style={styles.imagePreview} />
            {}
          </View>
        )}
      </View>
